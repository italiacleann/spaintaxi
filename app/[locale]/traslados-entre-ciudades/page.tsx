...
const PATH = "/es/traslados-entre-ciudades/";
const EN_PATH = "/city-to-city-transfers/";
...
export function generateMetadata(): Metadata {
  const dict = getServiceDictionary("city-to-city-transfers", "es");
  return buildServiceMetadata({ dict, locale: "es", path: PATH, enPath: EN_PATH, esPath: PATH });
}

export default async function TrasladosEntreCiudadesPage({
  params,
}: {
