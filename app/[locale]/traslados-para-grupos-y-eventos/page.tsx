...
const PATH = "/es/traslados-para-grupos-y-eventos/";
const EN_PATH = "/group-event-transfers/";
...
export function generateMetadata(): Metadata {
  const dict = getServiceDictionary("group-event-transfers", "es");
  return buildServiceMetadata({ dict, locale: "es", path: PATH, enPath: EN_PATH, esPath: PATH });
}

export default async function TrasladosParaGruposYEventosPage({
  params,
}: {
