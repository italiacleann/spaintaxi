...
const PATH = "/group-event-transfers/";
const ES_PATH = "/es/traslados-para-grupos-y-eventos/";
...
export function generateMetadata(): Metadata {
  const dict = getServiceDictionary("group-event-transfers", "en");
  return buildServiceMetadata({ dict, locale: "en", path: PATH, enPath: PATH, esPath: ES_PATH });
}

export default async function GroupEventTransfersPage({
  params,
}: {
