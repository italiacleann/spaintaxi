...
const PATH = "/es/traslados-aeropuerto/";
const EN_PATH = "/airport-transfers/";
...
export function generateMetadata(): Metadata {
  const dict = getServiceDictionary("airport-transfers", "es");
  return buildServiceMetadata({ dict, locale: "es", path: PATH, enPath: EN_PATH, esPath: PATH });
}

export default async function TrasladosAeropuertoPage({
  params,
}: {
