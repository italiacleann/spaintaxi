...
const PATH = "/cruise-port-transfers/";
const ES_PATH = "/es/traslados-puertos-cruceros/";
...
export function generateMetadata(): Metadata {
  const dict = getServiceDictionary("cruise-port-transfers", "en");
  return buildServiceMetadata({ dict, locale: "en", path: PATH, enPath: PATH, esPath: ES_PATH });
}

export default async function CruisePortTransfersPage({
  params,
}: {
