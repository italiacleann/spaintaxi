...
const PATH = "/city-to-city-transfers/";
const ES_PATH = "/es/traslados-entre-ciudades/";
...
export function generateMetadata(): Metadata {
  const dict = getServiceDictionary("city-to-city-transfers", "en");
  return buildServiceMetadata({ dict, locale: "en", path: PATH, enPath: PATH, esPath: ES_PATH });
}

export default async function CityToCityTransfersPage({
  params,
}: {
