...
const all = [...h1, ...h2, ...h3, ...h4, ...d1, ...sn1, ...a1, ...cc1, ...cc2, ...dt1];
...
const internalWhitelist = new Set([
  ...
  "/granada-airport-transfer/", "/granada/",
  ...
  "/es/traslados-para-grupos-y-eventos/", "/es/traslados-puertos-cruceros/", "/es/traslado-aeropuerto-granada/",
  "/es/granada/",
  // destination city pages linked from city-to-city / day-trip records
  "/cordoba/", "/es/cordoba/", "/cadiz/", "/es/cadiz/", "/marbella/", "/es/marbella/",
  "/almeria/", "/es/almeria/", "/barcelona/", "/es/barcelona/", "/malaga/", "/es/malaga/",
]);
